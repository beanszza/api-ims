...
public interface IDeliveryService
{
    ...
    Task<ApiResponse<PagedData<DeliveryResponse>>> GetDeliveriesAsync(int? poId = null, string? status = null, int page = 1, int pageSize = 50, CancellationToken ct = default);
