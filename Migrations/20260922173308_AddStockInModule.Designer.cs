...
namespace api_scm.Migrations
{
    ...
    [Migration("20260922173308_AddStockInModule")]
    partial class AddStockInModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domains.Entities.Discrepancy", b =>
                {
                    ...
                    b.Property<decimal>("CurrentReceivedQty")
                        .HasPrecision(18, 3)
                        .HasColumnType("numeric(18,3)");
                    ...
                    b.HasIndex("DeliveryId")
                        .HasDatabaseName("IX_Discrepancies_DeliveryId");

                    b.HasIndex("DiscrepancyNumber")
                        .IsUnique()
                        .HasDatabaseName("IX_Discrepancies_DiscrepancyNumber");

                    b.HasIndex("GrnId")
                        .HasDatabaseName("IX_Discrepancies_GrnId");

                    b.HasIndex("ItemId");

                    b.HasIndex("LossReportId")
                        .IsUnique();

                    b.HasIndex("NcrId");

                    b.HasIndex("PoId")
                        .HasDatabaseName("IX_Discrepancies_PoId");
            ...
            modelBuilder.Entity("Domains.Entities.GoodsReceipt", b =>
                {
                    ...
                    b.Property<string>("ReceivingBay")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("SupplierDrNumber")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domains.Entities.LossReport", b =>
                {
                    b.Property<int>("LossReportId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("LossReportId"));
                    ...
                    b.Property<string>("LossReportNumber")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasKey("LossReportId");

                    b.HasIndex("DiscrepancyId")
                        .HasDatabaseName("IX_LossReports_DiscrepancyId");

                    b.HasIndex("GrnId");

                    b.HasIndex("ItemId");

                    b.HasIndex("LossReportNumber")
                        .IsUnique()
            ...
            modelBuilder.Entity("Domains.Entities.PutAwayTransaction", b =>
                {
                    ...
                    b.HasIndex("GrnId")
                        .HasDatabaseName("IX_PutAwayTransactions_GrnId");
                    ...
                    b.HasIndex("QaInspectionId");

                    b.HasIndex("UomId");

                    b.ToTable("PutAwayTransactions");
                });
            ...
            modelBuilder.Entity("Domains.Entities.QualityInspection", b =>
                {
                    ...
                    b.Property<decimal>("TotalRejectedQuantity")
                        .HasPrecision(18, 3)
                        .HasColumnType("numeric(18,3)");
            ...
            modelBuilder.Entity("Domains.Entities.ReturnToVendor", b =>
                {
                    ...
                    b.Property<string>("ApprovalRequestNotes")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Domains.Entities.Discrepancy", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.LossReport", "LossReport")
                        .WithOne("Discrepancy")
                        .HasForeignKey("Domains.Entities.Discrepancy", "LossReportId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("Domains.Entities.ReturnToVendor", "ReturnToVendor")
                        .WithMany()
                        .HasForeignKey("RtvId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("Domains.Entities.GoodsReceiptItem", b =>
                {
                    b.HasOne("Domains.Entities.DeliveryItem", "DeliveryItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Domains.Entities.LossReport", b =>
                {
                    ...
                    b.HasOne("Domains.Entities.StockLedger", "StockLedgerEntry")
                        .WithMany()
            ...
            modelBuilder.Entity("Domains.Entities.PutAwayTransaction", b =>
                {
                    b.HasOne("Domains.Entities.Location", "DestinationLocation")
                        .WithMany()
                    ...
                    b.HasOne("Domains.Entities.GoodsReceiptItem", "GoodsReceiptItem")
                        .WithMany()
                    ...
                    b.HasOne("Domains.Entities.QualityInspection", "QaInspection")
                        .WithMany()
                        .HasForeignKey("QaInspectionId")
                        .OnDelete(DeleteBehavior.SetNull);
